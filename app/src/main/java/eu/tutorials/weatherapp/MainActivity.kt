...
import eu.tutorials.weatherapp.models.Weather
...
class MainActivity : AppCompatActivity() {
    ...
    //private var action_refresh: MenuItem?= null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //var action_refresh: MenuItem= findViewById(R.id.action_refresh)
        //action_refresh.setOnMenuItemClickListener { onOptionsItemSelected(action_refresh) }
    ...
    private fun showRationalDialogForPermission(){
        AlertDialog.Builder(this)
            .setMessage("It looks like you have turned off permissions required for this application. It can be turned on under Application Settings")
            .setPositiveButton(
                "GO TO SETTINGS"
            ){_,_->
                try{
